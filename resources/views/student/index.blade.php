                    ...
                    <div class="mx-auto order-0">
                        <ul class="navbar-nav mx-auto">
                            <li class="nav-item border-bottom-primary">
                                <a class="nav-link text-primary pt-1" href="{{ url('student/' .  $classroom[0]->name . '-' . $classroom[0]->code) . '?role=' . $_GET['role'] . '&classroom_id=' . $_GET['classroom_id'] }}">Stream</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary pt-1" href="{{ url('student/classwork/' .  $classroom[0]->name . '-' . $classroom[0]->code . '?role=' . $_GET['role'] . '&classroom_id=' . $classroom[0]->id) }}">Classwork</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-secondary pt-1" href="{{ url('student/member/' . $classroom[0]->name . '-' . $classroom[0]->code . '?role=' . $_GET['role'] . '&classroom_id=' . $classroom[0]->id) }}">Member</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="col-md-10 col-sm-8 p-0">
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <form name="form_create_announce" action="{{ ('/student/create_announce/' .  $classroom[0]->name . '-' . $classroom[0]->code) . '?role=' . $_GET['role'] . '&classroom_id=' . $_GET['classroom_id'] }}" method="POST">
                                    {{ csrf_field() }}
                            ...
                            <!-- Annoucement -->
                                <div class="card-body">
                                    <h6 class="card-title">
                                    <b>{{$announce->author}}</b> has Posted A New Annoucement:
                                    </h6>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php
                                    ...
                                    // echo $mat_id;
                                ?>
                                <a href="{{ url('student/material/' .  $classroom[0]->name . '-' . $classroom[0]->code) . '?role=' . $_GET['role'] . '&classroom_id=' . $_GET['classroom_id']. '&material_id=' . $mat_id }}">
                                    <div class="card-body">
                            ...
                            <div class="card shadow mb-4">
                                <?php
                                    $assign_id = $assign->id;
                                ?>
                                <a href="{{ url('student/assignment/' .  $classroom[0]->name . '-' . $classroom[0]->code) . '?role=' . $_GET['role'] . '&classroom_id=' . $_GET['classroom_id'] . '&assignment_id=' . $assign_id}}">
                                    <div class="card-body">
